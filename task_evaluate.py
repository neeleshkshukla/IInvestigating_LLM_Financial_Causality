#!/usr/bin/env python
# coding=utf-8
""" task2_evaluate.py - Scoring program for Fincausal 2023 Task

    (Adapted from Fincausal 2022 to deal with the background set)
...
def evaluate(truth, predict, classes):
    ...
    logging.debug(f'SKLEARN EVAL: {precision}, {recall}, {f1}')
...
class Test(unittest.TestCase):
    def _process_test_ok(self, t_text, p_text, t_labels, p_labels, precision, recall, f1, exact_match):
        # Load data
